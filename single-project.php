...
<div class="project">
  ...
  <section class="project__navigator">
    <div class="container">
      ...
      ?>
        <div class="col-md-5 text-right mb-5 mb-md-0">
          <a href="<?php echo get_permalink($previous->ID)?>">

            <div class="project__navigator__cover"
              style="background-image: url('<?php the_field('hero_image', $previous->ID); ?>')"></div>

            <div class="project__navigator__title">
              <h3 class="mt-4 pr-5"><span><?php the_field('client_name', $previous->ID) ?></span>
                <?php echo get_the_title($previous->ID) ?></h3>
            </div>
        ...
        <?php
            ...
            $nextID = $next->ID;
          ?>
        <div class="col-md-5 text-left mt-5 mt-md-0">
          <a href="<?php echo get_permalink($next->ID)?>">
            <div class="project__navigator__cover"
              style="background-image: url('<?php the_field('hero_image', $next->ID); ?>')"></div>
            <div class="project__navigator__title">
              <h3 class="mt-4 pl-5"><span><?php the_field('client_name', $next->ID) ?></span>
                <?php echo get_the_title($next->ID) ?></h3>
            </div>
          </a>
        </div>
